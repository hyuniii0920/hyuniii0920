...
* 🏢 **메가존클라우드(주)** | 프론트엔드 및 UX/UI 개발 인턴 `2025.11 - 2026.01`
    * 💻 React 기반 SaaS형 교육 플랫폼(LMS) 개발 및 4개 역할별 멀티테넌트 라우팅 설계
    * 애자일 개발 프로세스 주도
* 🏢 **제로웹** | 프론트엔드 개발 및 UX/UI 개발 인턴 `2024.07 - 2024.08`
    * 📍 위치 기반 노약자 케어 서비스 기획 및 Figma 디자인, 퍼블리싱 전 과정 수행
    * 🛠 기업 홈페이지 유지보수 및 브라우저 호환성 개선, 디자인-개발 간 협업 프로세스 최적화

## 🏆 Awards & Honors

* 🥇 **경성대학교 글로컬 아이디어 공모전** | 대상 (총장상) `2026.06`
* 🚀 **DIVE 2026 - DX Challenge 해커톤** | 본선 진출 (진행 중) `2026.07 - Present`

  
## 🌀 Activities & Leadership

* 🧪 **Infonet Lab** | 랩장 및 운영 총괄 `2022.03 - Present`
...
* 🤝 **Project 부산 IT 연합동아리** | 운영진 `2022.03 - Present`
    * 🛰 위치 기반 임베디드 솔루션 개발 (디자인&아이디어 부문 1위 수상)
...
* 🎨 **ArtBusan** | AR 기반 전시 정보 통합 가이드
    * 🕶️ Unity & ARCore 활용 평면 인식 기반 가상 도슨트 및 증강 정보 UI 구현
...
| **중 (Intermediate)** | <img src="https://img.shields.io/badge/Kotlin-7F52FF?style=flat-square&logo=Kotlin&logoColor=white"> <img src="https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=TypeScript&logoColor=white"> <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=FastAPI&logoColor=white"> <img src="https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=C&logoColor=black"> <img src="https://img.shields.io/badge/C%2B%2B-00599C?style=flat-square&logo=C%2B%2B&logoColor=white"> <img src="https://img.shields.io/badge/C%20Sharp-239120?style=flat-square&logo=C%20Sharp&logoColor=white"> |
| **하 - 공부중 (Novice)** | <img src="https://img.shields.io/badge/Spring%20Boot-6DB33F?style=flat-square&logo=Spring%20Boot&logoColor=white"> |
</p>

### 🤖 AI & Machine Learning
<p>
  <img src="https://img.shields.io/badge/Gemini%20Pro-0037FF?style=flat-square&logo=Google%20Gemini&logoColor=white">
  <img src="https://img.shields.io/badge/Claude%203.5-D97757?style=flat-square&logo=Anthropic&logoColor=white">
