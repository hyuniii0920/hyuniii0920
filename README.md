...
* 🥇 **경성대학교 글로컬 아이디어 공모전** | 대상 (총장상) `2026.06`
* 🛡️ **피싱스캠 예방을 위한 서비스 개발 경진대회** | 전체 644팀 중 상위 15% `2026`
...
* 🏫 **경성대학교 컴퓨터공학과** | 졸업예정 `2022 - 2026.08`
...
<p>
  ...
  <img src="https://img.shields.io/badge/Cloud%20SQL-4285F4?style=flat-square&logo=Google%20Cloud&logoColor=white">
...
<div align="center">
  <img
    src="https://capsule-render.vercel.app/api?type=waving&color=0:f8d5dc,100:fffbf0&height=190&section=header&text=Hello,%20Seohyun's%20World!&fontSize=40&fontColor=815f5f&animation=fadeIn&fontAlignY=36"
  />

  <a href="https://git.io/typing-svg">
    <img
      src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=18&pause=1000&color=815F5F&center=true&vCenter=true&width=500&lines=Frontend+Developer+%26+AI+Product+Builder;Designing+useful+experiences+with+technology."
      alt="Typing SVG"
    />
  </a>
  ...
  <a href="https://www.notion.so/SEOHYUN-CHO-658f109a9b758248804301d9b82ebddd">
...
사용자 경험을 설계하고, 이를 실제로 동작하는 제품으로 구현하는 개발자 **조서현**입니다.  
프론트엔드에서 시작해 AI 파이프라인, 백엔드, 데이터 설계까지 확장하며 사용자에게 실질적인 가치를 주는 서비스를 만듭니다.

## 💼 Experience

- **메가존클라우드(주) · ATU Data & Design Whole 팀**  
  프론트엔드 및 UX/UI 개발 인턴 `2025.11 - 2026.01`
  - B2B/B2C 멀티테넌트 SaaS LMS 프론트엔드 개발
  - 6개 직급 통합 라우팅, 테넌트별 브랜딩·기능 플래그, JWT Refresh Queue 패턴 적용

- **제로웹(IT)**  
  프론트엔드 개발 및 UX/UI 디자인 인턴 `2024.07 - 2024.08`
  - Care Bell 위치 기반 노약자 케어 서비스의 기획·Figma 디자인·퍼블리싱 전 과정 수행
  - 운영 서비스 UI 오류 및 브라우저 호환성 개선

## 🏆 Awards & Activities

- 🥇 **경성대학교 글로컬 아이디어 공모전** · 대상(총장상) `2026.06`
- 🚀 **DIVE 2026 - DX Challenge 해커톤** · 본선 진출 `2026.07 - Present`
- 🛡️ **피싱스캠 예방을 위한 서비스 개발 경진대회** · 전체 644팀 중 상위 15% `2026`
...
| :--- | :--- | :--- |
| [**CLAIR**](https://github.com/KS-LEXA/clair-ai) | AI Pipeline · Backend · PM | OCR·LLM·RAG 기반 AI 계약서 분석 서비스. 위험 조항, Safety Score, 근거 조항 제공 |
| [**Growbase**](https://github.com/hyuniii0920/mzc-lp-frontend) | Frontend | B2B/B2C 멀티테넌트 SaaS 학습관리시스템 |
| **PIYAK** | AI | SAM2로 K-pop 멤버별 안무 마스크 영상을 생성하는 모바일 앱 |
| [**ArtBusan**](https://github.com/hyuniii0920/ArtAR-Busan) | Planning · Android | QR·AR·4개국어·Offline-First 기반 부산 전시 안내 앱 |
| **SAI** | Planning · Frontend · Backend | OCR·LLM 기반 Android·Web 통합 스미싱 예방 서비스 |
| [**동백웨이**](https://github.com/KDA-4/KDA-server) | PM · UX/UI · Data/Backend | 동백전 데이터를 여행 탐색·예약·결제 경험으로 연결한 부산 관광 플랫폼 |
