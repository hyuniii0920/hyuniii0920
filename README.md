...
사용자 경험(UX)을 최우선으로 생각하며, **AI(LLM)**와 **프론트엔드/백엔드** 기술을 융합해 복잡한 비즈니스 문제를 해결하는 개발자 조서현입니다. 
...
* **메가존클라우드(주)** | 프론트엔드 및 UX/UI 개발 인턴 `2025.11 - 2026.01`
    ...
    * '바이브코딩' 기반 신속 프로토타이핑을 통한 애자일 개발 프로세스 주도
* **제로웹** | 프론트엔드 개발 및 UX/UI 개발 인턴
    * 위치 기반 노약자 케어 서비스 기획 및 Figma 디자인, 퍼블리싱 전 과정 수행
    * 기업 홈페이지 유지보수 및 브라우저 호환성 개선, 디자인-개발 간 협업 프로세스 최적화

## 🌀 Activities & Leadership

* **Infonet Lab** | 랩장 및 운영 총괄 `2026.02 - Present`
...
* 🎨 **ArtBusan** | AR 기반 전시 정보 통합 가이드
    * Unity & ARCore 활용 평면 인식 기반 가상 도슨트 및 증강 정보 UI 구현
